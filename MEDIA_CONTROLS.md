...
本文记录 1.08 在 1.03 音频功能基础上增加的控制面板及控制传输修正。
当前代码的 USB `bcdDevice=0x010a` 已为 altset 4–7 增加 192 kHz 透传载波，
用户已确认树莓派 Linux E-AC-3 / Dolby Atmos 透传；新增音频能力见 [SPDIF.md](SPDIF.md)。
本页的按键、LED 和 HID 控制说明仍适用。
